	...
	*/
	...
	Sequencer.prototype = {
		...
		playDummySound: function playDummySound() {
			var ctx = this;
			ctx.grid.canvas.addEventListener('click', function () {
				return ctx.audio.playDummySound();
			});
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sockethandler = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	SoundBites.prototype = {
		...
		createBites: function createBites(templates, defaultProps) {
			var _this = this;

			var count = this.bites.length,
			...
			templates.map(function (temp) {
				for (var i = 0; i < temp.createN; i++) {
					...
					var styleProps = {
						...
						position: 'absolute',
						height: _helpers2.default.toPixels(_this.cellSize),
						width: _helpers2.default.toPixels(_this.cellSize),
		...
		createRandomizedBite: function createRandomizedBite(id) {
			var color = _helpers2.default.toRGB(_helpers2.default.randInt(0, 255), _helpers2.default.randInt(0, 255), _helpers2.default.randInt(0, 255));
			this.createBites([{ filename: id, color: color, createN: 1 }], {
				top: _helpers2.default.toPixels(window.innerHeight / 2 - this.cellSize / 2),
				left: _helpers2.default.toPixels(window.innerWidth / 2 - this.cellSize / 2)
			});
		...
		getAllBitesExcept: function getAllBitesExcept(filename) {
			return this.bites.filter(function (bite) {
				return bite.bite.filename !== filename;
			});
		},
		...
		queryZIndices: function queryZIndices() {
			var zIndices = [];
			this.bites.map(function (bite) {
				var zIndex = bite.style.zIndex;
